...
export default function AreaMap({ center, handleCloseMap, handleApply, mapOpen, selectedAreaIndex=null }) {
	...
	const { values: { peDeliveryAreas = [] } } = useFormikContext();

	useEffect(()=>{
		if (mapOpen && selectedAreaIndex !== null) {
			const copy = Object.assign({}, peDeliveryAreas[selectedAreaIndex])
	...
	}, [center, selectedAreaIndex, mapOpen, peDeliveryAreas])
