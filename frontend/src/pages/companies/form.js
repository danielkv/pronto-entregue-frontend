...
function tField({field, label, form:{isSubmitting, errors}}) {
...
export default function PageForm ({values:{active, phones, emails}, setFieldValue, handleChange, isSubmitting}) {
	return (<Form>
		<Content>
			<Block>
				<BlockHeader>
